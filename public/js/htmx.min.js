;(function (e, t) {
  ...
  return function () {
    ...
    function h(e, t) {
      var r = e.matches || e.matchesSelector || e.msMatchesSelector ||
    ...
    function W(e, t) {
      if (t.indexOf("closest ") === 0) return [v(e, z(t.substr(8)))]
      else if (t.indexOf("find ") === 0) return [C(e, z(t.substr(5)))]
      else if (t === "next") return [e.nextElementSibling]
      else if (t.indexOf("next ") === 0) return [$(e, z(t.substr(5)))]
      else if (t === "previous") return [e.previousElementSibling]
      else if (t.indexOf("previous ") === 0) return [G(e, z(t.substr(9)))]
      else if (t === "document") return [document]
      else if (t === "window") return [window]
      else if (t === "body") return [document.body]
      else return re().querySelectorAll(z(t))
    }
    var $ = function (e, t) {
    ...
    function ue(e, t) {
      if (t) return W(e, t)[0]
      else return W(re().body, e)[0]
    }
    function s(e) {
      if (L(e, "String")) return C(e)
      else return e
    }
    function J(e, t, r) {
      if (A(t)) return { target: re().body, event: e, listener: t }
      else return { target: s(e), event: t, listener: r }
    }
    function Z(t, r, n) {
      Dr(function () {
        var e = J(t, r, n)
    ...
    function ge(e) {
      ...
      if (t) {
        if (t === "this") return de(e, "hx-target")
        else return ue(e, t)
      } else {
        var r = ae(e)
    ...
    function De(e, t, r, n, i) {
      switch (e) {
        ...
        default:
          ...
          else De(Q.config.defaultSwapStyle, t, r, n, i)
      }
    }
    function Xe(e) {
    ...
    function Je(e, t, r) {
      return Ve.exec(e.charAt(0)) && e !== "true" && e !== "false" &&
        e !== "this" && e !== r && t !== "."
    }
    function Ze(e, t, r) {
      if (t[0] === "[") {
    ...
    function Qe(e) {
            ...
            if (a === "every") {
              ...
              while (n.length > 0 && n[0] !== ",") {
                ...
                if (u === "changed") l.changed = true
                  ...
                  n.shift()
                  if (We.test(n[0])) { var f = Ke(n) }
                  else {
                    var f = y(n, p)
                    if (
                      f === "closest" || f === "find" || f === "next" ||
                      f === "previous"
                    ) {
                      n.shift()
                      var c = Ke(n)
                  ...
                  n.shift()
                  l[u] = y(n, p)
                } else fe(e, "htmx:syntax:error", { token: n.shift() })
              }
              r.push(l)
            }
          }
          if (n.length === i) fe(e, "htmx:syntax:error", { token: n.shift() })
          y(n, ze)
        } while (n[0] === "," && n.shift())
      }
      ...
      } else if (h(e, Ye)) return [{ trigger: "change" }]
    ...
    function nt(t, r, e) {
      if (
        t.tagName === "A" && rt(t) &&
          (t.target === "" || t.target === "_self") || t.tagName === "FORM"
      ) {
        r.boosted = true
        var n, i
        if (t.tagName === "A") {
    ...
    function at(e, t) {
      return ae(e).boosted && e.tagName === "A" && t.type === "click" &&
        (t.ctrlKey || t.metaKey)
    }
    function ot(e, t, r) {
      var n = e.eventFilter
      ...
      oe(t, function (n) {
        var i = function (e) {
          ...
          if (t.handledFor.indexOf(a) < 0) {
            ...
            if (s.target && e.target) if (!h(e.target, s.target)) return
            if (s.once) {
    ...
    function pt(e, t, r) {
      ...
      for (var i = 0; i < n.length; i++) {
        var a = n[i].split(/:(.+)/)
        if (a[0] === "connect") yt(e, a[1])
        if (a[0] === "swap") xt(e, a[1])
      }
    }
    function yt(t, e) {
    ...
    function Tt(n, e, t, r) {
      if (e.sseEvent) bt(n, r, e.sseEvent)
        ...
        if (!ot(e, n, Vt("load", { elt: n }))) Et(n, r, t, e.delay)
    ...
    function Lt(e) {
      if (e.querySelectorAll) {
        ...
        var r = e.querySelectorAll(
          w + t + ", form, [type='submit'], [hx-sse], [data-hx-sse], [hx-ws]," +
    ...
    function Ut(t) {
      ...
      if (r.initHash !== Re(t)) {
        ...
        var n = Ct(t, r, e)
        if (!n) {
          if (ne(t, "hx-boost") === "true") nt(t, r, e)
        ...
        if (
          t.tagName === "FORM" || ee(t, "type") === "submit" && o(t, "form")
        ) kt(t)
        var i = te(t, "hx-sse")
        if (i) pt(t, r, i)
        var a = te(t, "hx-ws")
    ...
    function ce(e, t, r) {
      ...
      r["elt"] = e
      var n = Vt(t, r)
      if (Q.logger && !jt(t)) Q.logger(e, t, r)
      if (r.error) {
        x(r.error)
    ...
    function $t(e) {
      ...
      for (var r = 0; r < t.length; r++) if (t[r].url === e) return t[r]
      return null
    }
    function Gt(e) {
    ...
    function ar(e) {
      ...
      if (
        e.type === "button" || e.type === "submit" || e.tagName === "image" ||
        e.tagName === "reset" || e.tagName === "file"
      ) return false
    ...
    function or(e, t, r) {
      if (e != null && t != null) {
        ...
        } else {if (Array.isArray(t)) r[e] = [n].concat(t)
          else r[e] = [n, t]}
      }
    }
    function sr(t, r, n, e, i) {
      if (e == null || ir(t, e)) return
      else t.push(e)
      if (ar(e)) {
        var a = ee(e, "name")
        var o = e.value
    ...
    function ur(e, t) {
      ...
      var s = h(e, "form") && e.noValidate !== true ||
        te(e, "hx-validate") === "true"
      if (o.lastButtonClicked) {
        s = s && o.lastButtonClicked.formNoValidate !== true
      }
      if (t !== "get") sr(r, i, a, v(e, "form"), s)
      sr(r, n, a, e, s)
      if (
        o.lastButtonClicked || e.tagName === "BUTTON" ||
      ...
      if (r) {
        ...
        if (i.length > 0) {
          for (var a = 0; a < i.length; a++) {
            ...
            else x("Unknown modifier in hx-swap: " + o)
          }
        }
      }
      return n
    ...
    function pr(e) {
      return ne(e, "hx-encoding") === "multipart/form-data" ||
    ...
    function br(e, t, r, n) {
      ...
      if (i) {
        ...
        for (var l in s) if (s.hasOwnProperty(l)) if (n[l] == null) n[l] = s[l]
      }
      return br(u(e), t, r, n)
    }
    function wr(e, t, r) {
    ...
    function Or(e, t, r) {
      ...
      if (r) {
        ...
        } else {return he(e, t, s(r.source), r.event, {
            handler: r.handler,
            headers: r.headers,
            values: r.values,
      ...
      } else return he(e, t, null, null, { returnPromise: true })
    }
    function qr(e) {
      var t = []
      while (e) {
    ...
    function Hr(e, t, r) {
      ...
      if (Q.config.selfRequestsOnly) if (!n) return false
    ...
    function he(t, r, n, i, a, e) {
      ...
      if (c) {
        ...
        if (v != null) if (v.toLowerCase() !== "dialog") t = v
      }
      ...
      if (m) {
        ...
        } else if (m === "replace") ce(g, "htmx:abort")
      ...
      var H = {
        ...
        verb: t,
        errors: C,
        withCredentials: a.credentials || O.credentials ||
    ...
    function Ar(l, u) {
      ...
      if (o.shouldSwap) {
        ...
        var v = mr(l, s)
        if (v.hasOwnProperty("ignoreTitle")) m = v.ignoreTitle
        ...
        var x = function () {
          try {
            ...
            if (t.elt && !se(t.elt) && ee(t.elt, "id")) {
              ...
              var a = {
                preventScroll: v.focusScroll !== undefined
                  ? !v.focusScroll
        ...
        if (
          b && ce(l, "htmx:beforeTransition", u) &&
        ...
        if (v.swapDelay > 0) setTimeout(x, v.swapDelay)
        else x()
      }
      if (a) {
        fe(
          ...
          "htmx:responseError",
          le({
            error: "Response Status Error Code " + f.status + " from " +
